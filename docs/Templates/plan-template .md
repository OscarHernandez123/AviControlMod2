...
<!--
  Documentar solo decisiones específicas de esta funcionalidad. El stack y la
  arquitectura compartidos viven en el documento enlazado arriba.
-->

**Performance Goals**: [objetivo medible de esta funcionalidad]
**Constraints**: [restricciones propias de la funcionalidad]
**Scale/Scope**: [alcance de esta funcionalidad]
